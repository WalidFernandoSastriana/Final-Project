...
export default function MovieDetailPage() {
  ...
  const movie = {
    ...
    description:
      'seorang wanita Amerika bernama Sara yang pergi ke hutan Aokigahara di Jepang untuk mencari saudara kembarnya yang hilang. Hutan Aokigahara dikenal sebagai "hutan bunuh diri" dan penuh dengan misteri dan hal-hal supranatural. ',
    youtube: "https://www.youtube.com/watch?v=TFCKlqhaONQ&pp=0gcJCfwAo7VqN5tD",
  };
